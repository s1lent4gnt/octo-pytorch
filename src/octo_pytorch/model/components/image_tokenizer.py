...
class SmallStem(nn.Module):
    ...
    def __init__(self, use_film: bool = False, patch_size: int = 32,
    ...
    def forward(self, observations: torch.Tensor, train: bool = True, cond_var: Optional[torch.Tensor] = None):
        """
        Args:
...
class SmallStem16(SmallStem):
    ...
    def __init__(self, use_film: bool = False,
                 kernel_sizes: Tuple[int, ...] = (3, 3, 3, 3),
                 strides: Tuple[int, ...] = (2, 2, 2, 2),
                 features: Tuple[int, ...] = (32, 96, 192, 384),
                 padding: Tuple[int, ...] = (1, 1, 1, 1),
